...
ButtonNextStr = 'Suivant';
ButtonBackStr = 'Retour';
ButtonDoneStr = 'Terminé';
ButtonWidth = 60;
ButtonHeight = 40;
TextHeight = 12;
...
if Shared.NPages > 1
    Shared.PageNumberHandle = uicontrol(WindowHandle,'Style','text','String','page X sur Y', ...
...
AnswerAllHandle = uicontrol(WindowHandle,'Style','text','String','Veuillez répondre à toutes les questions', ...
...
if Shared.NPages > 1
    set(Shared.PageNumberHandle,'string',['page ' num2str(Shared.CurrentPage) ' sur ' num2str(Shared.NPages)]);
end
