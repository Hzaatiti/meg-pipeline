function [Matrice_resultat ] = TNT_3_difficulties(Sujet)
...
numStimsAct = 6 ;          % Nombre de stimuli présenté par sujet (max 12)
numStimsRest = 0 ;          % Nombre de stimuli de repos '00+00' (max 6)
...
DrawFormattedText(window, ['Toulouse N-back Task - Instructions : \n\n'...
    ...
    '   - 1-back : comparez le résultat au résultat précédent.\n'...
    '   - 2-back : comparez le résultat au résultat calculé 2 items avant.\n'...
    'Vous allez utiliser le boîter gris pour répondre à cette tâche.'...
    '\n\nAppuyez sur une touche du boîter gris lorsque vous êtes prêt à commencer'], 'centerblock', 'center', couleur_police, wrapat, [], [], vSpacing);
Screen('Flip', window);
